...
class MyTestCase(unittest.TestCase):
    ...
    def test_existing(self):
        ...
        self.assertEqual(0, binary_search(2, [2, 2, 2, 2]), msg="You should return first occurence from the array.")
        self.assertEqual(0, binary_search(2, [2]), msg="You should return first occurence from the array.")
        self.assertEqual(None, binary_search(2, []), msg="You should return first occurence from the array.")
